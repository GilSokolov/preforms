...
export class Home {
  ...
  readonly heroSnippet = [
    ...
    { n: 6, html: '      <span class="prop">do</span><span class="op">:</span> <span class="cls">TriggerAction</span><span class="op">.</span><span class="prop">VALIDATE_ASYNC</span>, <span class="annot annot-indigo">async validation</span>' },
    ...
    { n: 16, html: '    <span class="prop">do</span><span class="op">:</span> <span class="cls">TriggerAction</span><span class="op">.</span><span class="prop">FETCH</span>,' },
  ...
  readonly asyncSnippet = [
    ...
    { n: 4, html: '    <span class="prop">do</span><span class="op">:</span> <span class="cls">TriggerAction</span><span class="op">.</span><span class="prop">VALIDATE_ASYNC</span>,' },
  ...
  readonly selectSnippet = [
    ...
    { n: 6, html: '    <span class="prop">do</span><span class="op">:</span> <span class="cls">TriggerAction</span><span class="op">.</span><span class="prop">FETCH</span>,' },
