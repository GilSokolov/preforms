...
import content from './dynamic-form-fetch.component.ts.txt';
import { DynamicFormFetchComponent } from './dynamic-form-fetch.component';
...
Perfect example of how @preforms/angular turns static forms into fully dynamic, backend-driven experiences.
  ...
  component: DynamicFormFetchComponent,
  assets: [
    {
      label: 'TS',
      language: 'typescript',
