 ...
 * - Defaults the field key to `"street"`
 * - Is required by default
 * - Accepts either a raw string value or a full field configuration
 */
export class Street extends TextField {
  /**
   * @param configOrValue - Initial street address value or full field configuration
  ...
  constructor(
    ...
    super({ key: "street", aria: { "aria-label": "Street" }, ...config });
  }
}
