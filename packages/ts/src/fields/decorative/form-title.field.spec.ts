...
import { FormTitle, FormTitleLevel } from "./form-title.field";

describe("FormTitle", () => {
  it("sets component to 'form-title'", () => {
    const field = new FormTitle("User Information");
  ...
  it("supports the (value, level) shorthand constructor", () => {
    const field = new FormTitle("Address Details", FormTitleLevel.H2);
